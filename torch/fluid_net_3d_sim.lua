...
mconf.buoyancyScale = 2.0 * (res / 128)
...
mconf.maxIter = 50  -- For jacobi or pcg only.
-- Option 1:
...
function visualizeData(batchGPU, hImage)
  ...
  -- Ignore the divergence of the plume.
  local divNorm = div[{{10, res}, {}}]:norm()
  print('  divNorm = ' .. divNorm)
